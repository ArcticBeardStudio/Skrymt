...
#include "FindPlayerUnitQueryContext.h"
...
void UFindPlayerUnitQueryContext::ProvideContext(FEnvQueryInstance& QueryInstance, FEnvQueryContextData& ContextData) const
{
	...
	ABasicEnemyAIController* AICon = Cast<ABasicEnemyAIController>((Cast<AActor>((QueryInstance.Owner).Get())->GetInstigatorController()));
